...
namespace GeneratorNS
{
    public class Generator
    {
        ...
        public Generator(List<(Dictionary<(int, int), ushort[]>, ushort)> r, Dictionary<ushort, TileRaw> t)
        {
            rules = r;
            tiles = t;
        }
        ...
        private readonly Dictionary<ushort, TileRaw> tiles;
        ...
        private class Tile
        {
            public Tile(List<(Dictionary<(int, int), ushort[]>, ushort)> r, Dictionary<ushort, TileRaw> t, Dictionary<(int, int), Tile> mp, (int, int) p, Generator g, ushort type)
            {
                _id = type;
                gen = g;
                pos = p;
            ...
            public Tile(List<(Dictionary<(int, int), ushort[]>, ushort)> r, Dictionary<ushort, TileRaw> t, Random rnd, Dictionary<(int, int), Tile> mp, (int, int) p, Generator g)
            {
                gen = g;
                pos = p;
                map = mp;
